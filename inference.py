...
class InteriorDesigner:
    ...
    def generate_design(
        ...
        # Convert batch array to list of individual design arrays
        # list() on a 4D array returns a list of 3D arrays (views), which is
        # equivalent to [designs_array[i] for i in range(num_variations)]
